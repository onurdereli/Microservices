...
namespace Course.IdentityServer.Services
{
    ...
    {
        //standarta uygun şekilde isimlendirme yapıldı normalde token-exchange olarak da kullanılabilir
        ...
        public async Task ValidateAsync(ExtensionGrantValidationContext context)
        {
            ...
            //herşey başarılıysa access_token'a sub'dan gelen değeri ve claimsleri gönderiyoruz
